  ...
  return (
    <AuthLayout title="Sign in" subtitle="Welcome back! We're glad to see you again.">
      <form onSubmit={onSubmit} className="space-y-4">
        ...
        <input autoComplete="current-password" className="w-full rounded-lg bg-white/90 text-gray-900 placeholder-gray-500 px-4 py-3 outline-none focus:ring-2 focus:ring-emerald-500" placeholder="Password" type="password" value={password} onChange={(e)=>setPassword(e.target.value)} />
