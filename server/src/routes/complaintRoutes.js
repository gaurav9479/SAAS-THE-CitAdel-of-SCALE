...
import { createComplaint, getMyComplaints, getComplaintsByStaff, getAllComplaints, getComplaintDetail, updateComplaintStatus, assignComplaintToStaff, getMyAssignments } from '../controllers/complaintController.js';
...
router.get('/my-assignments', requireAuth, requireRole('staff'), getMyAssignments);
...
router.patch('/:id/assign', requireAuth, requireRole('admin'), assignComplaintToStaff);
